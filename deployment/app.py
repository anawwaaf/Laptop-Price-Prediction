...
TouchScreen = st.selectbox(label='Touch Screen 0 = No, 1 =Yes', options=[0, 1])
...
Total_Storage_GB = Flash+HDD+SSD
...
OS_Laptop = st.selectbox(label='OS (Operating System)', options=['Windows', 'Linux', 'DOS'])

# convert into dataframe
data = pd.DataFrame({'Laptop_Brand':[Laptop_Brand],
